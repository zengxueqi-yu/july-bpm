(function ($) {
    ...
    $.extend(true, myflow.config.tools.states, {
        start: {
            ...
            name: {text: '<<start>>'},
            text: {text: '开始'},
            img: {src: '../static/flow/img/16/start_event_empty.png', width: 16, height: 16},
            props: {
                text: {
            ...
            name: {text: '<<end>>'},
            text: {text: '结束'},
            img: {src: '../static/flow/img/16/end_event_terminate.png', width: 16, height: 16},
            props: {
                text: {
                    name: 'text', label: '显示', value: '', editor: function () {
                        return new myflow.editors.textEditor();
        ...
        'end-cancel': {
            ...
            text: {text: '取消'},
            img: {src: '../static/flow/img/16/end_event_cancel.png', width: 16, height: 16},
            props: {
                text: {
                    name: 'text', label: '显示', value: '', editor: function () {
                        return new myflow.editors.textEditor();
        ...
        'end-error': {
            ...
            name: {text: '<<end-error>>'},
            text: {text: '错误'},
            img: {src: '../static/flow/img/16/end_event_error.png', width: 16, height: 16},
            props: {
                text: {
                    name: 'text', label: '显示', value: '', editor: function () {
                        return new myflow.editors.textEditor();
        ...
        state: {
            ...
            name: {text: '<<state>>'},
            text: {text: '状态'},
            img: {src: '../static/flow/16/task_empty.png', width: 16, height: 16},
            props: {
                text: {
                    name: 'text', label: '显示', value: '', editor: function () {
                        return new myflow.editors.textEditor();
        ...
        fork: {
            ...
            name: {text: '<<fork>>'},
            text: {text: '分支'},
            img: {src: '../static/flow/img/16/gateway_parallel.png', width: 16, height: 16},
            props: {
                text: {
                    name: 'text', label: '显示', value: '', editor: function () {
                        return new myflow.editors.textEditor();
        ...
        task: {
            ...
            name: {text: '<<task>>'},
            text: {text: '任务'},
            img: {src: '../static/flow/img/16/task_empty.png', width: 16, height: 16},
            props: {
                text: {
                    name: 'text', label: '显示', value: '', editor: function () {
                        return new myflow.editors.textEditor();
